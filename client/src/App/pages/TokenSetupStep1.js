                ...
                <div className="col">
                    <form className="row justify-content-center" onSubmit={this.handleSubmit}>
                        ...
                        <div className="col-md-5 mt-3 form-group">
                            ...
                            <div className="d-flex justify-content-between form-group">
                                <label htmlFor="mintable">Future minting <i className="fa fa-question-circle main-color" data-toggle="tooltip" data-placement="top" title="Start Time tooltip on top"></i></label>
